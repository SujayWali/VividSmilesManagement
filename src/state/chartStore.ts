...
export const useChartStore = create<ChartStore>()(
  persist(
    (set: (fn: (state: ChartStore) => Partial<ChartStore> | void) => void, get: () => ChartStore) => ({
      selectedTeeth: [],
      ...
      actions: {
        ...
        selectRange: (a: number, b: number) => {
          ...
          set(state => ({ ...state, selectedTeeth: range }));
        },
        clearSelection: () => set(state => ({ ...state, selectedTeeth: [] })),
        ...
        setNumberingSystem: (ns: NumberingSystem) => set(state => ({ ...state, numberingSystem: ns })),
        setDentition: (d: Dentition) => set(state => ({ ...state, dentition: d })),
        loadChart: (patientId: string, chart?: Chart) => {
          if (chart) {
            set(state => ({ ...state, chart }));
          } else {
            set(state => ({
              ...state,
              chart: {
